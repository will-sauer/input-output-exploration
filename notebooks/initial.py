...
#* extract the column from the Y matrix (this will include all final demand rows)
...
#* sum all rows to get total final demand (small check against the above data frame)
